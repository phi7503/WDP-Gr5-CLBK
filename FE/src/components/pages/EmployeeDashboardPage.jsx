...
export default function EmployeeDashboardPage() {
  ...
  const salesData = [
    ...
    },
    {
      ...
      ticketsSold: 60,
      ticketRevenue: 6000000,
      combosSold: 45,
      comboRevenue: 2250000,
    ...
    },
    {
      ...
      ticketsSold: 40,
      ticketRevenue: 4000000,
      combosSold: 25,
      comboRevenue: 1250000,
    ...
    },
    {
      ...
      ticketsSold: 55,
      ticketRevenue: 5500000,
      combosSold: 40,
      comboRevenue: 2000000,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-400">Theo dõi doanh số bán hàng của bạn</p>
          </div>
...
function ExportButtons({ salesData }) {
  const exportToCSV = () => {
    ...
    link.download = `doanh-so-${new Date().toISOString().split("T")[0]}.csv`;
    link.click();
  };
